...
class RUNCSP(Module):
    ...
    def forward(self, csp_data, steps,eval):
        ...
        for _ in range(steps):
            ...
            if eval:
                # print(y.shape)
                all_assignments.append(y.unsqueeze(1))
        ...
        # if eval:
        #     # all_assignments = torch.stack(all_assignments, dim=1)
        #     all_assignments=torch.tensor(all_assignments)
