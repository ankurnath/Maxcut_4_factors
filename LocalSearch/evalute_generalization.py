...
def test_GNN(train_distribution,test_distribution,model):
    
    current_directory=os.getcwd()
    model_load_path=os.path.join(current_directory,"pretrained agents",f'{train_distribution}_{model}')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--train_distribution", type=str, help="Train distribution of dataset")
    parser.add_argument("--test_distribution", type=str, help="Test distribution of dataset")
    parser.add_argument("--model", type=str, default=None, help="Model")

    args = parser.parse_args()

    # Accessing arguments using attribute notation, not dictionary notation
    test_GNN(train_distribution=args.train_distribution,test_distribution=args.test_distribution,model=args.model)